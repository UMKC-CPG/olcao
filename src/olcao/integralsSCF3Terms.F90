module O_IntegralsSCF3Terms

   ! Import necessary modules.
   use O_Kinds
   use O_Constants
#ifndef GAMMA
   use O_IntegralsSCF, only: coreValeOL, valeValeOL
#else
   use O_IntegralsSCF, only: coreValeOLGamma, valeValeOLGamma
#endif
   use HDF5
...
! Three center dipole moment integral.
...
subroutine ortho (opCode)
   ...
   use O_SetupIntegralsHDF5, only: atomDMOverlap_did, atomDims
...
end module O_IntegralsSCF3Terms
