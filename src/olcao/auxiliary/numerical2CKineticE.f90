...
do p = 1, 20
  do q = 1, 20
    ...
    do i = 0, 100
      ...
      ! necessary here.  There will be 7 segments, and the final result
    ...
    write(2,*) x_sum1*y_sum1*z_sum1 - x_sum2*y_sum2*z_sum2 - x_sum3*y_sum3*z_sum3 - &
    &x_sum4*y_sum4*z_sum4 - x_sum5*y_sum5*z_sum5 - x_sum6*y_sum6*z_sum6 - x_sum7*y_sum7*z_sum7
  end do !q
end do !p
close(2)
end program numerical2CKineticE
