module O_MainEVectHDF5
   ...
   ! Declare arrays that hold the dimensions of the eigenvector dataset.
...
subroutine initMainEVectHDF5 (main_fid)
   ...
   if (hdferr /= 0) stop 'Failed to set valeStates plid layout'
   call h5pset_chunk_f(valeStates_plid,2,valeStates,hdferr)
