...
subroutine neutralAndNuclearQPot
   ...
   ! Import the necessary HDF and MPI modules.
   use MPI_F08
   use O_MPI
   use HDF5
   ...
   if (hdferr /= 0) then
      call stopMPI("Failed to write pot alpha overlap.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to write non local neut q pot.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to write non local nuc q pot.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to write local neut q pot.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to write local nuc q pot.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to record potOLAndLocalQ success.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to close potOLAndLocalQ attribute.")
   endif
...
subroutine residualQ
   ...
   ! Import the necessary MPI and HDF modules
   use MPI_F08
   use O_MPI
   use HDF5
...
!            enddo
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to write non local residual charge.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to record nonLocalResidualQ success.")
   endif
   ...
   call MPI_BCAST(hdferr,1,MPI_INTEGER,0,MPI_COMM_WORLD,mpierr)
   if (hdferr /= 0) then
      call stopMPI("Failed to close nonLocalResidualQ attribute.")
   endif
