...
cycle
                  ...
                  write (11+h,200) "ATOMS_INVOLVED ",i,&
                        & currentNode2%atomSiteNumber,&
                        & currentNode3%atomSiteNumber
                  write (11+h,200) "LATTICE_INDICES_1 ",0,0,0
                  write (11+h,200) "LATTICE_INDICES_2 ",&
                        & currentNode2%latticeIndices
                  write (11+h,200) "LATTICE_INDICES_3 ",&
                        & currentNode3%latticeIndices
                  ...
                  write (11+h,300) "BOND_CENTROID ",&
                        & currentNode3%bondCentroid(:)
