...
subroutine readPotTypes(readUnit, writeUnit)
   ...
   call readData(mpiRank,readUnit,writeUnit,numPotTypes,&
         & len('NUM_POTENTIAL_TYPES'),'NUM_POTENTIAL_TYPES')
   ...
   do i = 1, numPotTypes
      ...
      call readData(mpiRank,readUnit,writeUnit,70,potTypes(i)%typeLabel,&
      ...
      call readData(mpiRank,readUnit,writeUnit,2,tempRealArray(1:2),&
      ...
      call readData(mpiRank,readUnit,writeUnit,potTypes(i)%covalentRadius,&
            & len('COVALENT_RADIUS'),'COVALENT_RADIUS')

      ! Read the number of electronic potential alphas for this type.
      call readData(mpiRank,readUnit,writeUnit,potTypes(i)%numAlphas,&
